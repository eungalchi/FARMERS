...
?>
	...
	<?php
		...
		$selsql = "SELECT address1,crop,picture,callitem FROM items WHERE email='$login_session'";
		$result = mysqli_query($conn,$selsql);
		$farmsql = "SELECT farmname,callitem FROM farms WHERE email='$login_session'";
		$myfarm = mysqli_query($conn,$farmsql);
	?>
	...
	<div class="banner-bottom">
		<div class="container">
			...
			<h2 class="title-w3-agileits inner">MY POST</h2>
			<p class="quia">Check Again </p>

<!---728x90--->

  <h3 class="page-header page-header icon-subheading"> My Item Checking</h3>
...
?>
				<div class="col-md-4 w3_agile_gallery_grid">
					<div class="agile_gallery_grid">
						<a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="MYITEMinfo.php?callitem=<?= $row["callitem"] ?>">
...
<div class="banner-bottom">
		<div class="container">
   <h3 class="page-header page-header icon-subheading"> My Farm Checking</h3>
			<div class="w3ls_gallery_grids">
<?php
	if (mysqli_num_rows($myfarm) > 0) {
		while($farmrow = mysqli_fetch_assoc($myfarm)){
?>

          <div class="icon-box col-md-3 col-sm-4"><a class="agile-icon" href="FARMinfo.php?callitem=<?= $farmrow["callitem"] ?>"><i class="fa fa-asl-interpreting" aria-hidden="true"></i> <?php print $farmrow["farmname"];?><span class="text-muted">♥</span></a></div>
