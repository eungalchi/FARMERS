...
?>
	...
	<?php
		...
		$myorders = "SELECT DISTINCT callitem FROM orders WHERE email='$login_session'";
		$order_list = mysqli_query($conn,$myorders);
	...
	<div class="banner-bottom">
		<div class="container">
			...
			<h2 class="title-w3-agileits inner">Order List</h2>
			<p class="quia">My Items </p>
<!---728x90--->

  <h3 class="page-header page-header icon-subheading">Ordered Items </h3>
