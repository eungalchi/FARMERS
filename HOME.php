...
<body>
	...
	<script>
		$(document).ready( function() {
			$("button.navbar-toggle collapsed").click( function() {
				$("div.collapse navbar-collapse navbar-right").toggleClass("collapse in");
			} );
		} );
	</script>
	...
	<script>
	function mobileMenu() {
	 var element = document.getElementsById("bs-example-navbar-collapse-1");
	 element.classList.toggle("collapse in");
 }
	</script>

	<!-- banner -->
	<div class="banner_top" id="home">
    <img class="background-video" src="농업.jpg" />
		<div data-vide-bg="농업.jpg">
							...
							<div id="m_nav_container" class="m_nav wthree_bg">
								<nav class="menu menu--sebastian">
									<ul id="m_nav_list" class="m_nav menu__list">
										<li class="m_nav_item active" id="m_nav_item_1"> <a href="HOME.php" class="link link--kumya"><i aria-hidden="true"></i><span data-letters="Home">Home</span></a></li>
